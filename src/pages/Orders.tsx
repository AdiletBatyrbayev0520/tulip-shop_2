  ...
  return (
    <div className="flex flex-col w-full h-full pb-24">
      ...
      <main className="px-5 py-4 space-y-8">
        {/* In Process Order */}
        {(activeTab === "All Orders" || activeTab === "In Process") && (
          <section>
            <h2 className="text-lg font-bold text-zinc-900 dark:text-white mb-4 px-1">
              In Process
            </h2>
            <div className="space-y-6">
              <div className="bg-surface-light dark:bg-surface-dark rounded-[2rem] p-5 shadow-soft border border-zinc-50 dark:border-zinc-800">
                <div className="flex gap-4 mb-5">
                  ...
                  <div className="flex-1 flex flex-col justify-center">
                    <div className="flex flex-col items-start mb-1">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-wider bg-accent-green/10 text-accent-green px-2.5 py-1 rounded-full mt-1.5">
                        In Process
                      </span>
                    </div>
                    <p className="text-xs font-medium text-primary mt-1">
                      Deliver on: May 12, 2024
                    </p>
                    <p className="text-xs text-zinc-400 mt-1">
                      #TLP-8829 • 20 Units
                    </p>
                    <p className="font-bold text-lg text-zinc-900 dark:text-white mt-1">
                      $42.00
                    </p>
                  </div>
                </div>
                ...
                <div className="px-1 mb-6">
                  <div className="relative h-1 w-full bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden mb-4">
                    <div
                      className="absolute top-0 left-0 h-full bg-accent-green rounded-full"
                      style={{ width: "75%" }}
                    ></div>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-[9px] font-bold text-accent-green uppercase tracking-tighter">
                        Delivery
                      </span>
                    </div>
                    <div className="flex flex-col items-center">
                ...
                <div className="flex gap-3">
                  <Link
                    to="/orders/8829"
                    className="flex-1 py-3.5 bg-zinc-900 dark:bg-white dark:text-zinc-900 text-white rounded-2xl font-bold text-sm tracking-wide shadow-lg shadow-zinc-200 dark:shadow-none text-center"
                  >
                    Track Delivery
                  </Link>
        ...
        {/* Ordered Order */}
        {(activeTab === "All Orders" || activeTab === "Ordered") && (
          <section>
            <h2 className="text-lg font-bold text-zinc-900 dark:text-white mb-4 px-1">
              Ordered
            </h2>
            <div className="space-y-6">
              <div className="bg-surface-light dark:bg-surface-dark rounded-[2rem] p-5 shadow-soft border border-zinc-50 dark:border-zinc-800">
                <div className="flex gap-4 mb-5">
                  ...
                  <div className="flex-1 flex flex-col justify-center">
                    <div className="flex flex-col items-start mb-1">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-wider bg-primary-light text-primary px-2.5 py-1 rounded-full mt-1.5">
                        Ordered
                      </span>
                    </div>
                    <p className="text-xs font-medium text-zinc-500 dark:text-zinc-400 mt-1">
                      Pickup on: May 15, 2024
                    </p>
                    <p className="text-xs text-zinc-400 mt-1">
                      #TLP-9012 • 12 Units
                    </p>
                ...
                <div className="flex gap-3">
                  <Link
                    to="/orders/9012"
                    className="flex-1 py-3.5 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-white rounded-2xl font-bold text-sm tracking-wide text-center"
                  >
                    Order Details
                  </Link>
              ...
              <div className="bg-surface-light dark:bg-surface-dark rounded-[2rem] p-5 shadow-soft border border-zinc-50 dark:border-zinc-800">
                <div className="flex gap-4 mb-5">
                  ...
                  <div className="flex-1 flex flex-col justify-center">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider bg-zinc-100 dark:bg-zinc-800 text-zinc-500 px-2.5 py-1 rounded-full w-fit mt-1.5 mb-2">
                      Completed
                    </span>
                    <div>
                      ...
                      <p className="font-bold text-lg text-zinc-900 dark:text-white mt-0.5">
                        $55.00
                      </p>
                    </div>
                  </div>
